...
if __name__ == "__main__":
    ...
    if conn is not None:
        ...
        # Insert reporters
        insert_reporter(conn, "srabony", "Srabony@gmail.com")
        insert_reporter(conn, "nasrin", "narin@gmail.com")
        insert_reporter(conn, "akter", "akter@gmail.com")
        insert_reporter(conn, "", "nasrin@gmail.com")
        insert_reporter(conn, "nasrin1234", "nasrin123@gmail.com")
